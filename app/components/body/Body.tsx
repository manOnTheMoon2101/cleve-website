...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative ">
      ...
      <TextRoll className={`text-xl text-secondary relative mt-6 tracking-tight flex flex-row flex-wrap`}>
  web <span className="text-accent animate-pulse mx-2 font-bold">developer</span>{" "}
  <span className="text-foreground mx-2">x</span> software{" "}
  <span className="text-accent animate-pulse mx-2 font-bold">engineer</span>{" "}
  <span className="text-foreground mx-2">x</span> ux{" "}
  <span className="text-accent animate-pulse mx-2 font-bold">designer</span>
</TextRoll>
      {/* <div
